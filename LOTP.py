...
#########################################################################
# LTOP  V0.00001 Developed for Diamond House Inc. by The Lead Developer #
######################################################################### 

##########################################################################
# THIS SOFTWARE SHOULD ONLY BE USED BY PROFESSIONAL AND FOR EDUCATIONAL #
# USE ONLY. Hack-Wise OR Diamond House Inc.WILL NOT TAKE # #ANY RESPONSIBILITIES IF THIS SOFTWARE #
...
# scanport under construction , (The full code will be added after testing
...
def identifyOUI(macaddress):
    """This function should identify the manufacturer of a given device based on its MAC address"""
    #This now works
